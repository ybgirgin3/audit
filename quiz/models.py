...
class Mark(models.Model):
    ...
    wrong_answers = JSONField(blank=True, null=True)  # Yanlış cevaplanan sorular ve risk seviyeleri
    created_at = models.DateTimeField(default=timezone.now)
    answered_questions = models.ManyToManyField(Question, related_name='marks', blank=True)
    def __str__(self):
...
class Result(models.Model):
    ...
    RISK_LEVELS = models.CharField(max_length=10, choices=Question.RISK_LEVELS)  # Sorunun zorluk seviyesi
