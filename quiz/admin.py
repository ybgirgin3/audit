...
class QuestionAdmin(admin.ModelAdmin):
    list_display = ["id", "question", "creator", "category", "risk_level", "info", "solution"]
...
class AuditAdmin(admin.ModelAdmin):
    ...
    filter_horizontal = ["categories"]  # This provides a more user-friendly interface for selecting categories

admin.site.register(Audit, AuditAdmin)

class UserAuditProgressAdmin(admin.ModelAdmin):
    list_display = ["user", "audit", "category", "progress", "started_on", "success_rate"]
